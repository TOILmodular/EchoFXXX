...
Analog Eurorack delay module with a number of control parameters, like input selection (mic or line/modular), CVs for original input and echo levels, CVs for delay time and feedback. Based on the [EchoFXXX delay module from Music From Outer Space](https://musicfromouterspace.com/analogsynth_new/ECHOFXXX/ECHOFXXX.php).
